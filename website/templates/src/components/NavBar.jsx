    ...
    <>
      ...
      >
        <Toolbar sx={{ 
          ...
          width: '100%',
          minHeight: { xs: 'var(--nav-height-mobile)', sm: 'var(--nav-height)' },
          px: { xs: 'var(--spacing-sm)', sm: 'var(--spacing-md)' }
        }}>
          {/* Left Side: Hamburger Menu + Logo */}
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <IconButton onClick={toggleSidebar} sx={{ color: 'var(--text-light)', mr: 'var(--spacing-sm)' }}>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' }, gap: 'var(--spacing-lg)' }}>
      ...
      <Drawer
        ...
        sx={{
          '& .MuiDrawer-paper': {
            ...
            background: 'var(--primary)',
            color: 'var(--text-light)',
            paddingTop: { xs: 'var(--nav-height-mobile)', sm: 'var(--nav-height)' },
            zIndex: 'var(--z-drawer)',
          },
        }}
      >
        ...
        <List>
          ...
          {currentNavItems.map((item) => (
            ...
            >
              <ListItemIcon sx={{ color: 'var(--text-light)' }}>{item.icon}</ListItemIcon>
          ...
          {user && (
            <>
              <Divider sx={{ my: 'var(--spacing-sm)', backgroundColor: 'var(--border-light)' }} />
          ...
          {!user ? (
            <>
              <ListItem button onClick={() => handleNavigation('/register')}>
                <ListItemIcon sx={{ color: 'var(--text-light)' }}><PersonAddIcon /></ListItemIcon>
                <ListItemText primary="Sign Up" />
              </ListItem>
              <ListItem button onClick={() => handleNavigation('/login')}>
                <ListItemIcon sx={{ color: 'var(--text-light)' }}><LoginIcon /></ListItemIcon>
                <ListItemText primary="Login" />
              </ListItem>
            </>
          ) : (
            <ListItem button onClick={onLogout}>
              <ListItemIcon sx={{ color: 'var(--text-light)' }}><LogoutIcon /></ListItemIcon>
